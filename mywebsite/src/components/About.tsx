...
When I’m not deep in code or training my brain with the latest algorithms, you might find me playing football, dancing like nobody’s watching, or hopping distros on my Linux journey—distro hopping is one of my guilty pleasures! Let’s connect and make tech magic happen!
          </p>
    </div>
  )
}
